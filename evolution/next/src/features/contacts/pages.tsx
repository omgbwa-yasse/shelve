...
const CONTACT_COLS: TableColumn<Entity>[] = [
  { key: 'name', label: 'Nom' },
...
export const routes: FeatureRoute[] = [
  { path: '/contacts', List: makeList(api.externalContactsApi, 'external-contacts', CONTACT_COLS, { title: 'Contacts externes', create: '/contacts/create' }), Form: makeForm(api.externalContactsApi, 'external-contacts', { title: 'Contact externe', back: '/contacts', fields: [{ name: 'name', label: 'Nom', required: true }, { name: 'email', label: 'Email' }, { name: 'phone', label: 'Téléphone' }] }) },
  { path: '/contacts/organisations', List: makeList(api.externalOrganizationsApi, 'external-organizations', CONTACT_COLS, { title: 'Organisations externes', create: '/contacts/organisations/create' }), Form: makeForm(api.externalOrganizationsApi, 'external-organizations', { title: 'Organisation externe', back: '/contacts/organisations', fields: [{ name: 'name', label: 'Nom', required: true }, { name: 'email', label: 'Email' }, { name: 'phone', label: 'Téléphone' }] }) },
];
