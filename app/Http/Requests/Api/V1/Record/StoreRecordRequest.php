...
class StoreRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Les anciens champs descriptifs figés (ISAD(G) + non-ISAD : content,
            // biographical_history, extent, quantity, ...) sont désormais des
            // MetadataDefinition rattachées au RecordType — validées dynamiquement
            // dans le contrôleur via MetadataValidationService, pas ici.
