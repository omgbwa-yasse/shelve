...
namespace App\Http\Requests\Api\V1\RecordSupport;
 ...
 */
class StoreRecordSupportRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|unique:record_supports|max:100',  // reprise du contrôleur Blade
