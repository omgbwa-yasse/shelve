...
class RecordDigitalFolderMetadataProfile extends Model
{
    use HasFactory;

    protected $table = 'record_digital_folder_metadata_profiles';
    ...
    /**
     * Get the folder type that owns this profile.
     */
