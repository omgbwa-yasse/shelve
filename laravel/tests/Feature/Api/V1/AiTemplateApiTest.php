...
/**
 * D14 — modèles de documents IA. Portage finalisé le 2026-08-04.
 */
class AiTemplateApiTest extends TestCase
{
    use DatabaseTransactions, WithPermissions;

    private const PERMISSIONS = ['ai_template'];
    ...
    {
        $this->getJson('/api/v1/ai-templates')->assertStatus(401);
    }
    ...
    {
        $this->actingAs($this->user, 'sanctum')
            ->postJson('/api/v1/ai-templates', [])
            ->assertStatus(422)
            ->assertJsonValidationErrors('template_file');
    }
}
