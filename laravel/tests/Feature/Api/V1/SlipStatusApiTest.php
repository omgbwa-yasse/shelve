...
/**
 * @generated par `php artisan make:api-resource-set` — domaine D04.
 *
 ...
 */
class SlipStatusApiTest extends TestCase
{
    use DatabaseTransactions, WithPermissions;

    /**
     * Préfixe des permissions pour cette ressource (voir SlipStatusPolicy).
     *
     ...
     * 'law_*', pas 'law_article_*'). Ouvrir app/Policies/SlipStatusPolicy.php pour
     * confirmer avant de faire confiance à ce test.
     */
    private const PERMISSIONS = ['slip_status'];
    ...
    {
        $this->getJson('/api/v1/slip-statuses')->assertStatus(401);
    }
