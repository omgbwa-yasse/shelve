...
class Mail extends Model
{
    ...
    */
    ...
    /**
     * Portée organisation (R03) : un courrier concerne l'organisation courante s'il est
     * émis par elle (`sender_organisation_id`), reçu par elle (`recipient_organisation_id`)
     * ou si une affectation de traitement lui a été confiée (`assigned_organisation_id`).
     * C'est exactement la lecture de `Mail::involvesOrganisation()`, étendue au filtrage
     * en base (l'index Blade borne chaque liste par l'organisation courante).
     */
