...
class AuthServiceProvider extends ServiceProvider
{
    ...
    \App\Models\Language::class => \App\Policies\LanguagePolicy::class,
        ...
        \App\Models\EmailAccount::class => \App\Policies\EmailAccountPolicy::class,
        \App\Models\EmailMessage::class => \App\Policies\EmailMessagePolicy::class,
        \App\Models\EmailTag::class => \App\Policies\EmailTagPolicy::class,
