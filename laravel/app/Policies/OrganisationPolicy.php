...
class OrganisationPolicy extends BasePolicy
{
     ...
     * Contrôlé par la permission `organisations_create` (RBAC piloté par la base),
     * comme UserPolicy pour `users_create`. Un agent habilité de la suite de
     * conformité doit pouvoir créer une organisation : l'exiger superadmin
     * rendait la permission en base inopérante (CONVENTIONS §3 / R04).
     */
