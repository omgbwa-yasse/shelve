 ...
 */
class StoreMetadataDefinitionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => 'required|string|max:50|unique:metadata_definitions,code',  // reprise du contrôleur Blade
            ...
            'is_system' => ['nullable', 'integer'],  // déduit du schéma
