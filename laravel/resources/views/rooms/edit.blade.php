...
<div class="compact-container">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('rooms.show', $room->id) }}" class="btn btn-outline-info btn-modern">
    ...
    <nav class="modern-breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('rooms.show', $room->id) }}" class="breadcrumb-item">
    ...
    <div class="form-card fade-in-up">
        <div class="form-header">
            ...
            <h3 class="mb-0">{{ __('Modifier les informations de la salle') }}</h3>
        </div>
        ...
        <form action="{{ route('rooms.update', $room->id) }}" method="POST" id="roomForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" 
                                ...
                                @foreach($typeOptions as $value => $label)
                                    <option value="{{ $value }}" {{ old('type', $room->type) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('visibility') is-invalid @enderror" 
                                ...
                                @foreach($visibilityOptions as $value => $label)
                                    <option value="{{ $value }}" {{ old('visibility', $room->visibility) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4"
                                      placeholder="Description détaillée de la salle (optionnel)">{{ old('description', $room->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label">
                                ...
                                {{ __('Informations actuelles') }}
                            </label>
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <div class="current-value">
                                        <strong>{{ __('Bâtiment actuel') }}:</strong> {{ $room->floor->building->name ?? 'N/A' }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="current-value">
                                        <strong>{{ __('Niveau actuel') }}:</strong> {{ $room->floor->name ?? 'N/A' }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="current-value">
                                        <strong>{{ __('Étagères') }}:</strong> {{ $room->shelves->count() ?? 0 }} étagère(s)
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="current-value">
                                        <strong>{{ __('Créée le') }}:</strong> {{ $room->created_at?->format('d/m/Y H:i') ?? 'N/A' }}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-actions">
                <a href="{{ route('rooms.show', $room->id) }}" class="btn btn-outline-secondary btn-modern">
