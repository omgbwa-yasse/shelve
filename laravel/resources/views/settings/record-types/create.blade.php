...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Créer une typologie</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('settings.record-types.store') }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label">Code <span class="text-danger">*</span></label>
                        <input type="text" name="code" value="{{ old('code') }}" class="form-control" placeholder="ex: CONTRAT" required>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="reference_list_id" class="form-select">
                            ...
                            @foreach($referenceLists as $list)
                                <option value="{{ $list->id }}" @selected(old('reference_list_id') == $list->id)>{{ $list->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="icon" value="{{ old('icon') }}" class="form-control" placeholder="fa-file">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Couleur</label>
                        <input type="text" name="color" value="{{ old('color') }}" class="form-control" placeholder="#3B82F6">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Préfixe de code</label>
                        <input type="text" name="code_prefix" value="{{ old('code_prefix') }}" class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Pattern de code</label>
                        <input type="text" name="code_pattern" value="{{ old('code_pattern') }}" class="form-control" placeholder="PREFIX-YEAR-SEQ">
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="default_access_level" class="form-select">
                            @foreach(['internal', 'public', 'confidential', 'secret'] as $level)
                                <option value="{{ $level }}" @selected(old('default_access_level', 'internal') == $level)>{{ $level }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="requires_versioning" value="1" id="rv"
                                           @checked(old('requires_versioning'))>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="max_file_size" value="{{ old('max_file_size') }}" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
