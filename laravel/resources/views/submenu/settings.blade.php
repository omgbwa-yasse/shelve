<div class="submenu-container py-2">
    ...
    <div class="submenu-section">
        ...
        <div class="submenu-content" id="mailSection">
            ...
            {{-- Toujours visible ici (contrairement au menu Mails) : c'est depuis cette
                 page que le module Email est activé/désactivé pour l'organisation. --}}
            <div class="submenu-item">
                <a class="submenu-link" href="{{ route('settings.email-accounts.index') }}">
                    <i class="bi bi-envelope-at"></i> {{ __('Comptes de messagerie (Email)') }}
                </a>
            </div>
        </div>
    </div>
