            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('workplaces.update', $workplace) }}">
                        ...
                        <div class="mb-3">
                            <label for="code" class="form-label">Code (adresse de l'espace)</label>
                            <input type="text" class="form-control @error('code') is-invalid @enderror"
                                   id="code" name="code" value="{{ old('code', $workplace->code) }}"
                                   placeholder="Ex. rh, sia2019, dg-sg" pattern="[a-zA-Z0-9]+(-[a-zA-Z0-9]+)*">
                            @error('code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Sert d'adresse : <code>/workplace/{code}</code>.</small>
                        </div>
