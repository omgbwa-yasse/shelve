...
<div class="container-fluid">
            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('public.opac-templates.index') }}">{{ __('OPAC Templates') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('Pages') }}</li>
                    </ol>
                </div>
                <div class="page-title-right">
                    <a href="{{ route('public.opac.pages.create') }}" class="btn btn-primary">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('public.opac.pages.index') }}" class="row g-3">
                        <div class="col-md-4">
                    ...
                    @if(request()->hasAny(['search', 'status', 'published']))
                        <div class="mt-2">
                            <a href="{{ route('public.opac.pages.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if($pages->count() > 0)
                        <form id="bulkActionForm" method="POST" action="{{ route('public.opac.pages.bulk-action') }}">
                            @csrf
                                        ...
                                        @foreach($pages as $page)
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <h6 class="mb-0">
                                                        <a href="{{ route('public.opac.pages.show', $page) }}"
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="{{ route('public.opac.pages.edit', $page) }}"
                        ...
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">
                                @if(request()->hasAny(['search', 'status', 'published']))
                                    ...
                                    <a href="{{ route('public.opac.pages.index') }}">{{ __('Clear filters') }}</a>
                                @else
