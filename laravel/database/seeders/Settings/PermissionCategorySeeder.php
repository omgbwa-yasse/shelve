...
class PermissionCategorySeeder extends Seeder
{
    ...
    private function createProjectsPermissions()
    {
        $permissions = [
            ...
            [
                'name' => 'project_risk_create',
                'category' => 'projects',
                'description' => 'Créer des risques de projet'
            ],
            [
                'name' => 'project_risk_update',
                'category' => 'projects',
                'description' => 'Modifier des risques de projet'
            ],
            [
                'name' => 'project_risk_delete',
                'category' => 'projects',
                'description' => 'Supprimer des risques de projet'
            ],
    ...
    /**
     * D14 - Sandbox Python de l'assistant IA. Ces permissions bornent ce que
     * l'IA peut exécuter : `open` crée le workspace, `write` écrit du code /
     * des données dans input/core/reference, `run` exécute le script Python,
     * `close` récupère les fichiers produits.
     */
    private function createSandboxPermissions()
    {
        $permissions = [
            [
                'name' => 'ai_sandbox_viewAny',
                'category' => 'ai',
                'description' => 'Voir tous les sandbox Python'
            ],
            [
                'name' => 'ai_sandbox_view',
                'category' => 'ai',
                'description' => 'Voir un sandbox Python et télécharger ses fichiers'
            ],
            [
                'name' => 'ai_sandbox_open',
                'category' => 'ai',
                'description' => 'Ouvrir un sandbox Python'
            ],
            [
                'name' => 'ai_sandbox_write',
                'category' => 'ai',
                'description' => 'Écrire des fichiers dans le sandbox (code, données)'
            ],
            [
                'name' => 'ai_sandbox_run',
                'category' => 'ai',
                'description' => 'Exécuter un script Python dans le sandbox'
            ],
            [
                'name' => 'ai_sandbox_close',
                'category' => 'ai',
                'description' => 'Clôturer le sandbox et récupérer les fichiers produits'
            ],
        ];
