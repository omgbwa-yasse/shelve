...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        */
        ...
        if (!Schema::hasTable('dolly_mails')) {
        ...
        if (!Schema::hasTable('dolly_records')) {
        ...
        if (!Schema::hasTable('dolly_slips')) {
        ...
        if (!Schema::hasTable('dolly_slip_records')) {
        ...
        if (!Schema::hasTable('dolly_buildings')) {
        ...
        if (!Schema::hasTable('dolly_shelves')) {
        ...
        if (!Schema::hasTable('dolly_containers')) {
        ...
        if (!Schema::hasTable('dolly_communications')) {
        ...
        if (!Schema::hasTable('dolly_rooms')) {
