...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('dolly_digital_folders')) {
        ...
        if (!Schema::hasTable('dolly_digital_documents')) {
        ...
        if (Schema::hasTable('record_artifacts') && !Schema::hasTable('dolly_artifacts')) {
        ...
        if (Schema::hasTable('record_physicals') && !Schema::hasTable('dolly_books')) {
            Schema::create('dolly_books', function(Blueprint $table){
                $table->unsignedBigInteger('book_id')->nullable(false);
                $table->unsignedBigInteger('dolly_id')->nullable(false);
                $table->foreign('book_id')->references('id')->on('record_physicals')->onDelete('cascade');
                $table->foreign('dolly_id')->references('id')->on('dollies')->onDelete('cascade');
                $table->timestamps();
        ...
        if (Schema::hasTable('record_book_publisher_series') && !Schema::hasTable('dolly_book_series')) {
