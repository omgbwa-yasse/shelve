...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('mail_priorities')) {
        ...
        if (!Schema::hasTable('mail_typologies')) {
        ...
        if (!Schema::hasTable('mail_containers')) {
        ...
        if (!Schema::hasTable('mails')) {
            Schema::create('mails', function (Blueprint $table) {
                ...
                $table->foreignId('typology_id')->nullable(true)->constrained('mail_typologies')->nullOnDelete();
        ...
        // Tables pivots
        if (!Schema::hasTable('mail_related')) {
        ...
        if (!Schema::hasTable('mail_archives')) {
        ...
        if (!Schema::hasTable('mail_attachment')) {
        ...
        if (!Schema::hasTable('mail_author')) {
