...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('workflow_templates', function (Blueprint $table) {
            ...
            $table->index(['category', 'is_active'], 'idx_wf_template_cat_active');
        });
        ...
        Schema::create('workflow_instances', function (Blueprint $table) {
            ...
            $table->index(['current_step_id', 'status'], 'idx_wf_instance_step_status'); // Index ajouté
        });
        ...
        Schema::create('workflow_step_instances', function (Blueprint $table) {
            ...
            $table->index(['workflow_instance_id', 'status'], 'idx_wf_step_inst_wf_status');
            $table->index(['assigned_to_user_id', 'status'], 'idx_wf_step_inst_user_status');
            $table->index(['assigned_to_organisation_id', 'status'], 'idx_wf_step_inst_org_status');
            $table->index(['assignment_type', 'status'], 'idx_wf_step_inst_assign_status');
        });
        ...
        Schema::create('tasks', function (Blueprint $table) {
            ...
            $table->index(['due_date', 'status', 'priority'], 'idx_task_due_status_priority'); // Index composé amélioré
        ...
        Schema::create('task_assignments', function (Blueprint $table) {
            ...
            $table->index(['task_id', 'assignee_type'], 'idx_task_assignment_type');
        ...
        Schema::create('organisation_delegations', function (Blueprint $table) {
            ...
            $table->index(['delegating_organisation_id', 'is_active'], 'idx_org_delegation_from');
            $table->index(['delegate_organisation_id', 'is_active'], 'idx_org_delegation_to');
        ...
        Schema::create('task_comments', function (Blueprint $table) {
            ...
            $table->index(['task_id', 'created_at'], 'idx_task_comments_date');
        ...
        Schema::create('notifications', function (Blueprint $table) {
            ...
            $table->index(['priority', 'read_at'], 'idx_notification_priority_read');
        });
        ...
        Schema::create('notification_subscriptions', function (Blueprint $table) {
            ...
            $table->unique(['user_id', 'event_type', 'channel'], 'notif_sub_unique');
        ...
        Schema::create('mail_metrics', function (Blueprint $table) {
            ...
            $table->unique(['mail_id', 'metric_date', 'metric_type'], 'mail_metric_unique');
        ...
        Schema::create('email_templates', function (Blueprint $table) {
            ...
            $table->index(['category', 'is_active'], 'idx_email_tpl_cat_active');
            $table->unique(['name', 'category'], 'email_tpl_name_cat_unique');
        });
        ...
        Schema::table('mails', function (Blueprint $table) {
            ...
            // La colonne estimated_processing_time existe déjà dans une migration antérieure
            ...
            $table->index(['current_assignee_user_id', 'status'], 'idx_mails_user_status');
            $table->index(['current_assignee_organisation_id', 'status'], 'idx_mails_org_status');
        });
    ...
    public function down(): void
    {
        ...
        Schema::table('mails', function (Blueprint $table) {
            ...
            $table->dropColumn([
                ...
                'urgency_level',
                // 'estimated_processing_time', // Déjà géré par une autre migration
                'processing_notes',
                'metadata',
