...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('record_languages')) {
        ...
        // Add language_id foreign key to record_physicals (if table exists)
        if (Schema::hasTable('record_physicals')) {
            Schema::table('record_physicals', function (Blueprint $table) {
                if (!Schema::hasColumn('record_physicals', 'language_id')) {
                    $table->foreignId('language_id')
                        ->nullable()
                        ->after('language_material')
