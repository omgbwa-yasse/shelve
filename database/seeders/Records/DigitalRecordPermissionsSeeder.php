...
class DigitalRecordPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('âœ… ' . count($permissions) . ' permissions for digital records created/updated');
        ...
        if ($superadminRole) {
            ...
            $this->command->info('âœ… All digital record permissions assigned to superadmin role');
        } else {
            $this->command->warn('âš ï¸  Superadmin role not found. Permissions created but not assigned.');
        }
    }
}
