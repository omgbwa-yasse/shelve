    ...
    public function run(): void
    {
        ...
        $publicUsers = [
            [
                ...
                'first_name' => 'Jean',
                'phone1' => '0123456789',
                'phone2' => '', // Empty string instead of NULL
            ...
            [
                ...
                'first_name' => 'Pierre',
                'phone1' => '0345678901',
                'phone2' => '0678901234', // Include second phone
        ...
        // (include the rest of your PublicPortalSeeder code here)
        ...
        $publicNews = [
            [
                ...
                'summary' => 'Lancement de notre portail public pour l\'accès en ligne aux archives numérisées.',
                'user_id' => 1,
                'is_published' => true,
                'status' => 'published',
                'featured' => true,
            ...
            [
                ...
                'title' => 'Exposition temporaire - Les archives racontent',
                ...
                'summary' => 'Exposition du 15 juin au 15 septembre 2025 sur l\'histoire de notre institution.',
                'user_id' => 1,
                'is_published' => true,
                'status' => 'published',
                'featured' => false,
            ...
            [
                ...
                'summary' => 'Nouvelle collection d\'archives numérisées de la période 1950-1970 sur l\'aménagement urbain.',
                'user_id' => 1,
                'is_published' => true,
                'status' => 'published',
                'featured' => false,
