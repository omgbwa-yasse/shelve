...
class OpacTemplatesSeeder extends Seeder
{
        ...
        foreach ($templates as $template) {
            PublicTemplate::updateOrCreate(
                ...
                [
                    ...
                    'parameters' => $template['variables'], // Utilisation des variables comme paramètres
                    'values' => [], // Valeurs par défaut vides
    ...
    private function getModernMinimalDefinition(): array
    {
        return [
            'name' => 'Modern Minimal',
            'description' => 'Design moderne et minimaliste avec beaucoup d\'espace blanc et typographie épurée.',
    ...
    private function getAcademicProDefinition(): array
    {
        return [
            'name' => 'Academic Pro',
            'description' => 'Template orienté académique avec mise en page structurée pour institutions éducatives.',
    ...
    private function getDarkThemeDefinition(): array
    {
        return [
            'name' => 'Dark Theme',
            'description' => 'Thème sombre élégant pour une expérience de navigation confortable en faible luminosité.',
    ...
    private function getColorfulCreativeDefinition(): array
    {
        return [
            ...
            'description' => 'Template créatif avec couleurs vives et animations pour une expérience dynamique.',
...
<body class="opac-classic">
    ...
    <main class="container my-4">
        <div class="search-section">
            ...
            <input type="text" class="form-control classic-search" placeholder="Entrez vos mots-clés...">
        </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{library_name}} - Bibliothèque Académique</title>
    <style>
        {{custom_css}}
        .academic-header {
            background: {{primary_color}};
...
<body class="opac-academic">
    <header class="academic-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1>{{library_name}}</h1>
                    <p class="lead">Ressources académiques et scientifiques</p>
                </div>
                <div class="col-md-4">
                    <div class="text-end">
    ...
    <main class="container my-4">
        <div class="academic-section">
            ...
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Titre, auteur, mots-clés...">
                </div>
                <div class="col-md-3">
...
<body class="opac-dark">
    <header class="dark-header">
        <div class="container">
            ...
            <p>Catalogue numérique - Mode nuit</p>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="dark-card p-4">
                    ...
                    <div class="mt-3">
                        <span class="badge" style="background: {{accent_color}}">Nouveautés</span>
            ...
            <div class="col-md-4">
                <div class="dark-card p-3">
                    <h5 style="color: {{accent_color}}">Accès rapide</h5>
                    <ul class="list-unstyled">
                        <li><a href="#" style="color: {{text_color}}">• Catalogue</a></li>
                        <li><a href="#" style="color: {{text_color}}">• Réservations</a></li>
                        <li><a href="#" style="color: {{text_color}}">• Mon compte</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{library_name}} - Créatif</title>
    <style>
        {{custom_css}}
        .creative-header {
...
<body class="opac-creative">
    <header class="creative-header text-center">
        <div class="container">
            ...
            <p class="lead">Découvrez, explorez, apprenez !</p>
        </div>
    </header>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-8">
                <div class="text-center">
                    <h2 style="color: {{primary_color}}">🔍 Que voulez-vous découvrir ?</h2>
                    <div class="mt-3">
                        <input type="text" class="form-control creative-search" placeholder="Tapez ici pour commencer votre aventure...">
                        <button class="btn creative-btn mt-3">Partir à la découverte !</button>
                    </div>
                </div>
            </div>
        </div>
