        ...
        <header class="single-line-header">
            <div class="header-container">
                ...
                <nav class="header-nav">
                    @if(Auth::user()->hasPermissionTo('module_bulletin_boards_access'))
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_repositories_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_communications_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_transferrings_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_deposits_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_tools_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_dollies_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_ai_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_public_access'))
                    <div class="header-nav-item">
                    ...
                    @endif
                    @if(Auth::user()->hasPermissionTo('module_settings_access'))
                    <div class="header-nav-item">
