    ...
    <div class="row">
        ...
        <div class="collapse show" id="statisticsMenu">
            <ul class="list-unstyled pl-3">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href=""><i class="bi bi-clipboard-check"></i> {{ __('request') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href=""><i class="bi bi-arrow-left-right"></i> {{ __('transfer') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href=""><i class="bi bi-box-seam"></i> {{ __('deposit') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href=""><i class="bi bi-hammer"></i> {{ __('tool') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href=""><i class="bi bi-truck"></i> {{ __('carts') }}</a>
                </li>
            </ul>
        </div>
    </div>
