        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Nouveau Contact Externe</h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('external.contacts.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('external_organization_id') is-invalid @enderror" id="external_organization_id" name="external_organization_id">
                                        ...
                                        @foreach ($organizations as $id => $name)
                                            <option value="{{ $id }}" {{ old('external_organization_id', request()->get('organization_id')) == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_primary_contact" name="is_primary_contact" value="1" {{ old('is_primary_contact') ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('external.contacts.index') }}" class="btn btn-secondary">Annuler</a>
