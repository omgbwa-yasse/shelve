    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (senderType === 'external_contact') {
                    senderSelected = document.getElementById('external_sender_id').value !== '';
                } else if (senderType === 'external_organization') {
                    senderSelected = document.getElementById('external_sender_organization_id').value !== '';
                } else if (senderType === 'organisation') {
                    senderSelected = document.getElementById('sender_organisation_id').value !== '';
                }
                ...
                submitBtn.innerHTML = '<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>Enregistrement en cours...';
