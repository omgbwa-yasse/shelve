...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('mail-received.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="organisation_send_id" class="form-label">Organisation d'envoi</label>
                    <div class="input-group">
                ...
                <div class="col-md-6 mb-3">
                    <label for="user_send_id" class="form-label">Utilisateur d'envoi</label>
                    <div class="input-group">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="bi bi-send"></i> Créer le courrier entrant
            </button>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const organisationSendId = document.getElementById('organisation_send_id');
            ...
            organisationItems.forEach(item => {
                item.addEventListener('click', (e) => {
                    ...
                    organisationSendId.value = item.dataset.id;
            ...
            const userSendId = document.getElementById('user_send_id');
            ...
            userItems.forEach(item => {
                item.addEventListener('click', (e) => {
                    ...
                    userSendId.value = item.dataset.id;
