...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('terms.associative-relations.store', $term->id) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('terms.associative-relations.index', $term->id) }}" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </div>
