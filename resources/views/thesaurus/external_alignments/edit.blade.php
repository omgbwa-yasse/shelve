...
@section('title', 'Modifier un alignement externe')

@section('content')
<div class="container-fluid">
    <h1>Modifier l'alignement externe</h1>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('terms.external-alignments.update', [$term->id, $externalAlignment->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="url" name="external_uri" id="external_uri" class="form-control @error('external_uri') is-invalid @enderror" value="{{ old('external_uri', $externalAlignment->external_uri) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="external_label" id="external_label" class="form-control @error('external_label') is-invalid @enderror" value="{{ old('external_label', $externalAlignment->external_label) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="external_vocabulary" id="external_vocabulary" class="form-control @error('external_vocabulary') is-invalid @enderror" value="{{ old('external_vocabulary', $externalAlignment->external_vocabulary) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="match_type" id="match_type" class="form-control @error('match_type') is-invalid @enderror" required>
                                @foreach($matchTypes as $code => $name)
                                    <option value="{{ $code }}" {{ old('match_type', $externalAlignment->match_type) == $code ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
