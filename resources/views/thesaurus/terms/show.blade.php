...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('term-translations.create', $term) }}" class="btn btn-primary">Ajouter une traduction </a>
        <a href="{{ route('term-related.create', $term) }}" class="btn btn-primary">Ajouter une une équivalent </a>
    </div>
@endsection
