...
<div class="container-fluid workplace-dashboard">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            {{-- DASHLETS "Dossiers épinglés" / "Documents en Vedette" / "Contenu récent"
                 retirés le 2026-08-06 avec le partage de fichiers dans un Workplace
                 (WorkplaceFolder/WorkplaceDocument, dépendaient de RecordDigitalFolder/
                 RecordDigitalDocument) — voir App\Models\Record, le modèle unifié. --}}
        </div>
