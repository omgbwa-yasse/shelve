...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="bi bi-search"></i> {{ __('Recherche') }}</h1>
    </div>

    <div class="card mb-4">
        <div class="card-body">
            <form method="POST" action="{{ route('library.search') }}">
                @csrf
                <div class="row">
                    <div class="col-md-10">
                        <input type="text" name="query" class="form-control form-control-lg"
                               placeholder="{{ __('Rechercher un livre, auteur ou revue...') }}"
            ...
            <div class="mt-3">
                <a href="{{ route('library.search.advanced') }}" class="btn btn-link">
