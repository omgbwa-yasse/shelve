...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Créer un nouveau type de document numérique</h1>
                    ...
                    <form action="{{ route('settings.document-types.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror"
                                           ...
                                           placeholder="ex: DOC_PDF" maxlength="50">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           ...
                                           placeholder="ex: Document PDF" maxlength="255">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      placeholder="Décrivez ce type de document...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('icon') is-invalid @enderror"
                                           ...
                                           placeholder="ex: bi bi-file-pdf" maxlength="100">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_file_size') is-invalid @enderror"
                                           id="max_file_size" name="max_file_size" value="{{ old('max_file_size') }}"
                                           min="1" placeholder="ex: 104857600">
                                    <small class="form-text text-muted">En octets (ex: 100MB = 104857600)</small>
                                    @error('max_file_size')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-check mb-3 mt-4">
                                    <input type="checkbox" class="form-check-input" id="require_virus_scan"
                                           name="require_virus_scan" value="1" {{ old('require_virus_scan', true) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="require_virus_scan">
                                        Analyser les virus
                                    </label>
                                    <small class="form-text text-muted d-block">Activer l'analyse antivirus pour ce type</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-check mb-3">
                                    ...
                                    <small class="form-text text-muted d-block">Les documents de ce type devront être approuvés</small>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('settings.document-types.index') }}" class="btn btn-secondary">Annuler</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="small">
                        ...
                        <li>La <strong>taille maximale</strong> restreint les fichiers acceptés</li>
                        <li>L'<strong>analyse antivirus</strong> protège vos documents</li>
                    </ul>
                    ...
                    <ul class="small">
                        ...
                        <li>Configurer les types de dossiers autorisés</li>
