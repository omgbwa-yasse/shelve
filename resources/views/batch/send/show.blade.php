                                        ...
                                        <tbody>
                                            @foreach($batchTransaction->mails as $mail)
                                                <tr>
                                                    ...
                                                    <td>{{ $mail->name ?? '—' }}</td>
                                                    <td>{{ optional($mail->recipientOrganisation)->name ?? optional($mail->recipient)->name ?? '—' }}</td>
                                                    <td>{{ $mail->date ? \Illuminate\Support\Carbon::parse($mail->date)->format('d/m/Y') : '—' }}</td>
                                                    <td class="text-end">
                                                        <a href="{{ route('mail-send.show', $mail->id) }}" class="btn btn-sm btn-outline-secondary" title="Voir le courrier">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                        @if($batchTransaction->batch)
