                    ...
                    <form action="{{ route('bulletin-boards.events.update', [$bulletinBoard['id'], $event->id]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="status" id="status-draft" value="draft" {{ old('status', $event->status) == 'draft' ? 'checked' : '' }}>
                                <label class="btn btn-outline-warning" for="status-draft">
                                    <i class="fas fa-pencil-alt me-1"></i> Brouillon
                                </label>

                                <input type="radio" class="btn-check" name="status" id="status-published" value="published" {{ old('status', $event->status) == 'published' ? 'checked' : '' }}>
                                <label class="btn btn-outline-success" for="status-published">
                                    <i class="fas fa-check-circle me-1"></i> Publié
                                </label>

                                <input type="radio" class="btn-check" name="status" id="status-cancelled" value="cancelled" {{ old('status', $event->status) == 'cancelled' ? 'checked' : '' }}>
