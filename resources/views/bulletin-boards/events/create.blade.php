...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('bulletin-boards.events.store', $bulletinBoard) }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="add_attachments">
                                Ajouter des pièces jointes après création
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="{{ route('bulletin-boards.events.index', $bulletinBoard) }}" class="btn btn-secondary">Annuler</a>
                    </div>
                </div>
            </form>
        </div>
