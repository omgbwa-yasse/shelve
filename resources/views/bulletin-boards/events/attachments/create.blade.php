...
<div class="container">
    <div class="row mb-4">
        <div class="col-md-8">
            ...
            <p class="text-muted">
                Événement:
                <a href="{{ route('bulletin-boards.events.show', [$bulletinBoard, $event]) }}">{{ $event->name }}</a>
            </p>
        </div>
        <div class="col-md-4 text-end">
            <a href="{{ route('bulletin-boards.events.attachments.index', [$bulletinBoard, $event]) }}" class="btn btn-outline-secondary">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('bulletin-boards.events.attachments.store', [$bulletinBoard, $event]) }}" method="POST" enctype="multipart/form-data" id="attachment-form">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                Formats acceptés: PDF, JPG, JPEG, PNG, GIF, MP4, AVI, MOV.<br>
                        ...
                        <div class="mb-3">
                            ...
                            <a href="{{ route('bulletin-boards.events.attachments.index', [$bulletinBoard, $event]) }}" class="btn btn-secondary">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>
...
<script src="{{ asset('js/event-attachments.js') }}"></script>
@endsection
