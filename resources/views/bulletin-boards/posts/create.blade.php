...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('bulletin-boards.posts.store', $bulletinBoard) }}" method="POST">
                @csrf
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <a href="{{ route('bulletin-boards.posts.index', $bulletinBoard) }}" class="btn btn-secondary">Annuler</a>
                    </div>
                </div>
            </form>
        </div>
