                                        ...
                                        <select class="form-select @error('action_type_id') is-invalid @enderror"
                                            ...
                                            @foreach($actionTypes as $actionType)
                                                <option value="{{ $actionType->id }}"
                                                    {{ old('action_type_id') == $actionType->id ? 'selected' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('input') is-invalid @enderror"
                                              id="input" name="input" rows="4" required>{{ old('input') }}</textarea>
                                    @error('input')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('expected_output') is-invalid @enderror"
                                              id="expected_output" name="expected_output" rows="4" required>{{ old('expected_output') }}</textarea>
