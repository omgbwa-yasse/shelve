<!-- Transfer Modal - Digital Folder -->
<div class="modal fade" id="transferModal" tabindex="-1" role="dialog" aria-labelledby="transferModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="transferModalLabel">
                    <i class="fas fa-exchange-alt"></i> {{ __('Transfer Digital Folder to Physical Archive') }}
                </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">
                            {{ __('Search and select the physical archive record to associate this digital folder with.') }}
                        </small>
                    </div>
                    ...
                    <div class="alert alert-warning" role="alert">
                        ...
                        <p class="mb-0">
                            {{ __('After confirmation, this digital folder and all its contents will be associated with the physical record and permanently deleted from the digital storage system.') }}
                        </p>
                    </div>
                </div>
