...
/**
 * @generated par `php artisan make:api-resource-set` — domaine D05.
 *
...
class ReservationApiTest extends TestCase
{
    ...
    /**
     * Préfixe des permissions pour cette ressource (voir ReservationPolicy).
     *
     ...
     * 'law_*', pas 'law_article_*'). Ouvrir app/Policies/ReservationPolicy.php pour
     * confirmer avant de faire confiance à ce test.
     */
    private const PERMISSIONS = ['reservation'];
    ...
    {
        $this->getJson('/api/v1/reservations')->assertStatus(401);
    }
