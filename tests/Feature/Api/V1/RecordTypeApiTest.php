 ...
 */
class RecordTypeApiTest extends TestCase
{
    use DatabaseTransactions, WithPermissions;

    /**
     * Préfixe des permissions pour cette ressource (voir RecordTypePolicy).
     *
     ...
     * 'law_*', pas 'law_article_*'). Ouvrir app/Policies/RecordTypePolicy.php pour
     * confirmer avant de faire confiance à ce test.
     */
    private const PERMISSIONS = ['record_type'];
    ...
    {
        $this->getJson('/api/v1/record-types')->assertStatus(401);
    }
